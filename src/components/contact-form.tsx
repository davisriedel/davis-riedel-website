      ...
      >
        ...
        <div>
          <label className="flex items-center text-sm text-gray-700 dark:text-gray-300">
            ...
            />
              {lang === "de" ? (
                <span>Ich habe die <AnimatedLink href="/de/datenschutz">
                  Datenschutzerklärung
                </AnimatedLink> gelesen und stimme ihr zu.</span>
              ) : (
                <span>I have read the <AnimatedLink href="/en/privacy">
                  Privacy Policy
                </AnimatedLink> and consent to it.</span>
              )}
          </label>
        </div>

        <Button type="submit" effect="gooeyLeft" className="w-full bg-indigo-950 hover:bg-indigo-800 dark:bg-indigo-900 dark:hover:bg-indigo-800 text-white">
