	...
	return (
		<div className="prose dark:prose-invert prose-h4:mt-12">
			...
			<p>
				...
				dieser Website erfasst werden, werden auf den Servern der Hoster
			...
			<p>
				Unsere Hoster werden Ihre Daten nur insoweit verarbeiten, wie dies zur
				Erfüllung ihrer Leistungspflichten erforderlich ist und unsere Weisungen
				in Bezug auf diese Daten befolgen.
			</p>
			<p>Wir setzen folgende Hoster ein:</p>

			<h4>
				<i>Hosting unserer Domains:</i>
			</h4>
			<p>
				<strong>goneo Internet GmbH</strong>
				<br />
				Dresdener Straße 18
				<br />
				32423 Minden
			...
			<h4>
				<i>Hosting unserer Website (Server und CDN):</i>
			</h4>
			<p>
			...
			<h4>
				<i>Hosting unseres Mailservers:</i>
			</h4>
			<p>
			...
			<p>
				Im Falle von Verstoßen gegen die DSGVO steht den Betroffenen ein
			...
			<p>Folgende Cookies und Dienste werden auf dieser Website eingesetzt:</p>
			<ul>
				<li>
					Local Sorage Item das Ihre Auswahl von Light- oder Darkmode speichert.
				</li>
			</ul>
			<p>
				Wir verwenden aktuell keine weiteren Cookies. Es wird ausschließlich
				dieser technisch notwendige Cookie verwendet.
			</p>
			...
			<p>
				...
				gehostet. Der sendende Mailserver wird von <b>Resend</b> gehostet. Der
				empfangende Mailserver wird von <b>Apple</b> gehostet. Die Kontaktdaten
				der jeweiligen Hoster finden Sie oben.
			</p>
		</div>
	);
}
