export function Privacy() {
	return (
		<div className="prose dark:prose-invert prose-h4:mt-12">
...
<h4><i>Hosting unserer Domains:</i></h4>
<p>
    <strong>goneo Internet GmbH</strong><br />
    Dresdener Straße 18<br />
    32423 Minden<br />
    Telefon 0571-783 44 44<br />
    info@goneo.de
</p>
<p>
  ...
  Telefon: +49 721 / 7540755 - 0<br />
  Telefax: +49 721 / 7540755 - 9<br />
  Web: www.netcup.com<br />
  E-Mail: mail@netcup.de
</p>

<h4><i>Hosting unserer Website (Server und CDN):</i></h4>
<p>
...
<h4><i>Hosting unseres Mailservers:</i></h4>
<p>
...
<p>
    Im Falle von Verstoßen gegen die DSGVO steht den Betroffenen ein Beschwerderecht bei einer Aufsichtsbehörde, insbesondere in dem Mitgliedstaat ihres gewöhnlichen Aufenthalts, ihres Arbeitsplatzes oder des Orts des mutmaßlichen Verstoßes zu. Das Beschwerderecht besteht unbeschadet anderweitiger verwaltungsrechtlicher oder gerichtlicher Rechtsbehelfe.
</p>
...
<p>
    ...
    erwünschter Funktionen (z. B. für die Warenkorbfunktion)
    ...
    lit. a DSGVO und § 25 Abs. 1 TTDSG); die Einwilligung ist jederzeit
    widerrufbar.
</p>
<p>
...
<p>
    Folgende Cookies und Dienste werden auf dieser Website eingesetzt:
</p>
    <ul>
      <li>Local Sorage Item das Ihre Auswahl von Light- oder Darkmode speichert.</li>
    </ul>
    <p>Wir verwenden aktuell keine weiteren Cookies. Es wird ausschließlich dieser technisch notwendige Cookie verwendet.</p>

<h3>Kontaktformular</h3>
<p>Daten, die Sie über das Kontaktformular eingeben, werden per E-Mail an mail@davis-riedel.de übermittelt. Die Domain wird bei <b>GoNeo</b> (Kontaktdaten s.o.) gehostet. Der Mailserver wird von <b>Resend</b> (Kontaktdaten s.o.) gehostet.</p>
		</div>
	);
}
