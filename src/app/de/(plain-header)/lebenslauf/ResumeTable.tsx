    ...
    <div className="overflow-x-scroll">
      <table className="w-full min-w-[600px] border-collapse border border-gray-300">
        <tbody>
          ...
          {/* Bildung Section */}
          <tr>
            <th className="p-2 text-left font-semibold text-lg" colSpan={2}>
              Bildung
            </th>
          </tr>
          <tr className="border-gray-300 border-b">
            ...
            <td className="p-2">
              Studium M.Ed. Quereinstieg gymnasiales Lehramt Mathematik und
          ...
          <tr className="border-gray-300 border-b">
            ...
            <td className="p-2">
              Kreisvorsitzender der Jusos Enzkreis/Pforzheim
            </td>
          </tr>
          <tr className="border-gray-300 border-b">
